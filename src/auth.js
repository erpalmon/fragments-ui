...
export async function signOut() {
  ...
  const logoutUrl = `https://${process.env.AWS_COGNITO_HOSTED_UI_DOMAIN}/logout?client_id=${process.env.AWS_COGNITO_CLIENT_ID}&logout_uri=${encodeURIComponent(process.env.OAUTH_SIGN_OUT_REDIRECT_URL)}`;
